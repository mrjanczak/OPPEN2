...
class BookkEntryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Model.map.BookkEntryTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('AppBundle\\Model\\BookkEntry');
    ...
    {
        $this->addRelation('Bookk', 'AppBundle\\Model\\Bookk', RelationMap::MANY_TO_ONE, array('bookk_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('Account', 'AppBundle\\Model\\Account', RelationMap::MANY_TO_ONE, array('account_id' => 'id', ), null, null);
        $this->addRelation('FileLev1', 'AppBundle\\Model\\File', RelationMap::MANY_TO_ONE, array('file_lev1_id' => 'id', ), null, null);
        $this->addRelation('FileLev2', 'AppBundle\\Model\\File', RelationMap::MANY_TO_ONE, array('file_lev2_id' => 'id', ), null, null);
        $this->addRelation('FileLev3', 'AppBundle\\Model\\File', RelationMap::MANY_TO_ONE, array('file_lev3_id' => 'id', ), null, null);
    } // buildRelations()
