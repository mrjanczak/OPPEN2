...
class CostDocTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Model.map.CostDocTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('AppBundle\\Model\\CostDoc');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CostDocIncome', 'AppBundle\\Model\\CostDocIncome', RelationMap::ONE_TO_MANY, array('id' => 'cost_doc_id', ), 'CASCADE', null, 'CostDocIncomes');
    } // buildRelations()
