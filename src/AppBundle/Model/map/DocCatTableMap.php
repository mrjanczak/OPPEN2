...
class DocCatTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Model.map.DocCatTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('AppBundle\\Model\\DocCat');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('FileCat', 'AppBundle\\Model\\FileCat', RelationMap::MANY_TO_ONE, array('file_cat_id' => 'id', ), null, null);
        $this->addRelation('CommitmentAcc', 'AppBundle\\Model\\Account', RelationMap::MANY_TO_ONE, array('commitment_acc_id' => 'id', ), null, null);
        $this->addRelation('TaxCommitmentAcc', 'AppBundle\\Model\\Account', RelationMap::MANY_TO_ONE, array('tax_commitment_acc_id' => 'id', ), null, null);
        $this->addRelation('Doc', 'AppBundle\\Model\\Doc', RelationMap::ONE_TO_MANY, array('id' => 'doc_cat_id', ), 'CASCADE', null, 'Docs');
    } // buildRelations()
