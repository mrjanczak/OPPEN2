...
class ReportEntryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Model.map.ReportEntryTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('AppBundle\\Model\\ReportEntry');
    ...
    {
        $this->addRelation('Report', 'AppBundle\\Model\\Report', RelationMap::MANY_TO_ONE, array('report_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
