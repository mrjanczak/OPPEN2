...
class TemplateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.AppBundle.Model.map.TemplateTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('AppBundle\\Model\\Template');
    ...
    {
        $this->addRelation('Report', 'AppBundle\\Model\\Report', RelationMap::ONE_TO_MANY, array('id' => 'template_id', ), null, null, 'Reports');
        $this->addRelation('Contract', 'AppBundle\\Model\\Contract', RelationMap::ONE_TO_MANY, array('id' => 'template_id', ), null, null, 'Contracts');
    } // buildRelations()
