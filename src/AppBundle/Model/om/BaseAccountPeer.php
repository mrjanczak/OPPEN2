...
use AppBundle\Model\map\AccountTableMap;
...
abstract class BaseAccountPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Account';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\AccountTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseAccountPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\AccountTableMap());
      }
    }
