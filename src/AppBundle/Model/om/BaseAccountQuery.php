...
abstract class BaseAccountQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'AppBundle\\Model\\Account';
        }
    ...
    public function useFileCatLev1Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FileCatLev1', '\AppBundle\Model\FileCatQuery');
    }
    ...
    public function useFileCatLev2Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FileCatLev2', '\AppBundle\Model\FileCatQuery');
    }
    ...
    public function useFileCatLev3Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FileCatLev3', '\AppBundle\Model\FileCatQuery');
    }
    ...
    public function useDocCatRelatedByCommitmentAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DocCatRelatedByCommitmentAccId', '\AppBundle\Model\DocCatQuery');
    }
    ...
    public function useDocCatRelatedByTaxCommitmentAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DocCatRelatedByTaxCommitmentAccId', '\AppBundle\Model\DocCatQuery');
    }
    ...
    public function useProjectRelatedByIncomeAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ProjectRelatedByIncomeAccId', '\AppBundle\Model\ProjectQuery');
    }
    ...
    public function useProjectRelatedByCostAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ProjectRelatedByCostAccId', '\AppBundle\Model\ProjectQuery');
    }
    ...
    public function useProjectRelatedByBankAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ProjectRelatedByBankAccId', '\AppBundle\Model\ProjectQuery');
    }
    ...
    public function useIncomeRelatedByBankAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'IncomeRelatedByBankAccId', '\AppBundle\Model\IncomeQuery');
    }
    ...
    public function useIncomeRelatedByIncomeAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'IncomeRelatedByIncomeAccId', '\AppBundle\Model\IncomeQuery');
    }
    ...
    public function useCostRelatedByBankAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CostRelatedByBankAccId', '\AppBundle\Model\CostQuery');
    }
    ...
    public function useCostRelatedByCostAccIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CostRelatedByCostAccId', '\AppBundle\Model\CostQuery');
    }
