...
abstract class BaseBookkEntryQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'AppBundle\\Model\\BookkEntry';
        }
    ...
    public function useAccountQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Account', '\AppBundle\Model\AccountQuery');
    }
    ...
    public function useFileLev1Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FileLev1', '\AppBundle\Model\FileQuery');
    }
    ...
    public function useFileLev2Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FileLev2', '\AppBundle\Model\FileQuery');
    }
    ...
    public function useFileLev3Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FileLev3', '\AppBundle\Model\FileQuery');
    }
