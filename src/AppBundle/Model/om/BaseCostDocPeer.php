...
use AppBundle\Model\map\CostDocTableMap;
...
abstract class BaseCostDocPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\CostDoc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\CostDocTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCostDocPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\CostDocTableMap());
      }
    }
