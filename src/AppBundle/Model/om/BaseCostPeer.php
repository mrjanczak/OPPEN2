...
use AppBundle\Model\map\CostTableMap;
...
abstract class BaseCostPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Cost';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\CostTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCostPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\CostTableMap());
      }
    }
