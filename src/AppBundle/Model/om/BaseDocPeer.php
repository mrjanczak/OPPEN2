...
use AppBundle\Model\map\DocTableMap;
...
abstract class BaseDocPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Doc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\DocTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseDocPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\DocTableMap());
      }
    }
