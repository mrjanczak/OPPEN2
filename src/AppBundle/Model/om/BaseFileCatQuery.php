...
abstract class BaseFileCatQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'AppBundle\\Model\\FileCat';
        }
    ...
    public function useSubFileCatQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SubFileCat', '\AppBundle\Model\FileCatQuery');
    }
    ...
    public function useAccountRelatedByFileCatLev1IdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'AccountRelatedByFileCatLev1Id', '\AppBundle\Model\AccountQuery');
    }
    ...
    public function useAccountRelatedByFileCatLev2IdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'AccountRelatedByFileCatLev2Id', '\AppBundle\Model\AccountQuery');
    }
    ...
    public function useAccountRelatedByFileCatLev3IdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'AccountRelatedByFileCatLev3Id', '\AppBundle\Model\AccountQuery');
    }
