...
abstract class BaseIncomeQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'AppBundle\\Model\\Income';
        }
    ...
    public function useBankAccQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'BankAcc', '\AppBundle\Model\AccountQuery');
    }
    ...
    public function useIncomeAccQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'IncomeAcc', '\AppBundle\Model\AccountQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \AppBundle\Model\CostIncomeQuery A secondary query class using the current class as primary query
     */
    public function useCostIncomeQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCostIncome($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CostIncome', '\AppBundle\Model\CostIncomeQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \AppBundle\Model\CostDocIncomeQuery A secondary query class using the current class as primary query
     */
    public function useCostDocIncomeQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CostDocIncome', '\AppBundle\Model\CostDocIncomeQuery');
    }
