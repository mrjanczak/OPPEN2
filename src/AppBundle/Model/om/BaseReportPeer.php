...
use AppBundle\Model\map\ReportTableMap;
...
abstract class BaseReportPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Report';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\ReportTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseReportPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\ReportTableMap());
      }
    }
