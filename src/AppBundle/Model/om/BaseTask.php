...
abstract class BaseTask extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'AppBundle\\Model\\TaskPeer';
    ...
    /**
     * The value for the send_reminder field.
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $send_reminder;
    ...
    /**
     * Get the [send_reminder] column value.
     *
     * @return boolean
     */
    ...
    public function setDesc($v)
    {
        ...
        if ($this->desc !== $v) {
            $this->desc = $v;
            $this->modifiedColumns[] = TaskPeer::DESC;
        }
    ...
    public function setFromDate($v)
    {
        ...
        if ($this->from_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TaskPeer::FROM_DATE;
            }
    ...
    public function setToDate($v)
    {
        ...
        if ($this->to_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TaskPeer::TO_DATE;
            }
        } // if either are not null
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = TaskPeer::COMMENT;
        }
    ...
    /**
     * Sets the value of the [send_reminder] column.
     ...
     * @return Task The current object (for fluent API support)
     */
    public function setSendReminder($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->send_reminder !== $v) {
            $this->send_reminder = $v;
            $this->modifiedColumns[] = TaskPeer::SEND_REMINDER;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = TaskPeer::USER_ID;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = TaskPeer::SORTABLE_RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->send_reminder = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            TaskPeer::shiftRank(-1, $this->getSortableRank() + 1, null, $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // sortable behavior
                if (!$this->isColumnModified(TaskPeer::RANK_COL)) {
                    $this->setSortableRank(TaskQuery::create()->getMaxRankArray($con) + 1);
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaskPeer::DESC)) {
            $modifiedColumns[':p' . $index++]  = '`desc`';
        }
        if ($this->isColumnModified(TaskPeer::FROM_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`from_date`';
        }
        if ($this->isColumnModified(TaskPeer::TO_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`to_date`';
        }
        if ($this->isColumnModified(TaskPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`comment`';
        }
        if ($this->isColumnModified(TaskPeer::SEND_REMINDER)) {
            $modifiedColumns[':p' . $index++]  = '`send_reminder`';
        }
        if ($this->isColumnModified(TaskPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(TaskPeer::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`project_id`';
        }
        if ($this->isColumnModified(TaskPeer::SORTABLE_RANK)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`comment`':
                        ...
                        break;
                    case '`send_reminder`':
                        $stmt->bindValue($identifier, (int) $this->send_reminder, PDO::PARAM_INT);
                        break;
                    case '`user_id`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setSendReminder($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskPeer::DESC)) $criteria->add(TaskPeer::DESC, $this->desc);
        if ($this->isColumnModified(TaskPeer::FROM_DATE)) $criteria->add(TaskPeer::FROM_DATE, $this->from_date);
        if ($this->isColumnModified(TaskPeer::TO_DATE)) $criteria->add(TaskPeer::TO_DATE, $this->to_date);
        if ($this->isColumnModified(TaskPeer::COMMENT)) $criteria->add(TaskPeer::COMMENT, $this->comment);
        if ($this->isColumnModified(TaskPeer::SEND_REMINDER)) $criteria->add(TaskPeer::SEND_REMINDER, $this->send_reminder);
        if ($this->isColumnModified(TaskPeer::USER_ID)) $criteria->add(TaskPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(TaskPeer::PROJECT_ID)) $criteria->add(TaskPeer::PROJECT_ID, $this->project_id);
        if ($this->isColumnModified(TaskPeer::SORTABLE_RANK)) $criteria->add(TaskPeer::SORTABLE_RANK, $this->sortable_rank);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSendReminder($this->getSendReminder());
    ...
    {
        return $this->getSortableRank() == TaskQuery::create()->getMaxRankArray($con);
    }
     ...
     * @param     PropelPDO  $con      optional connection
     *
     * @return    Task the current object
     *
     * @throws    PropelException
     */
    public function insertAtRank($rank, PropelPDO $con = null)
    {
        $maxRank = TaskQuery::create()->getMaxRankArray($con);
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        if ($newRank < 1 || $newRank > TaskQuery::create()->getMaxRankArray($con)) {
        ...
        try {
            ...
            TaskPeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $con);
    ...
    public function moveToBottom(PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $bottom = TaskQuery::create()->getMaxRankArray($con);
