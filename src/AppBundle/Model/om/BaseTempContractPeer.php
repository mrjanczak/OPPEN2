...
use AppBundle\Model\map\TempContractTableMap;
...
abstract class BaseTempContractPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\TempContract';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\TempContractTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTempContractPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\TempContractTableMap());
      }
    }
