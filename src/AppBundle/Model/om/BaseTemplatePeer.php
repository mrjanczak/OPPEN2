...
use AppBundle\Model\map\TemplateTableMap;
...
abstract class BaseTemplatePeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Template';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\TemplateTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTemplatePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\TemplateTableMap());
      }
    }
