...
use AppBundle\Model\map\YearTableMap;
...
abstract class BaseYearPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Year';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\YearTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseYearPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\YearTableMap());
      }
    }
