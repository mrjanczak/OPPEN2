...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'FOS\\UserBundle\\Propel\\UserPeer';
     ...
     * @return PropelObjectCollection|Task[] List of Task objects
     */
    public function getTasksJoinProject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TaskQuery::create(null, $criteria);
