...
class CostTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Oppen.ProjectBundle.Model.map.CostTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Oppen\\ProjectBundle\\Model\\Cost');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CostIncome', 'Oppen\\ProjectBundle\\Model\\CostIncome', RelationMap::ONE_TO_MANY, array('id' => 'cost_id', ), 'CASCADE', null, 'CostIncomes');
        $this->addRelation('CostDoc', 'Oppen\\ProjectBundle\\Model\\CostDoc', RelationMap::ONE_TO_MANY, array('id' => 'cost_id', ), 'CASCADE', null, 'CostDocs');
        $this->addRelation('Contract', 'Oppen\\ProjectBundle\\Model\\Contract', RelationMap::ONE_TO_MANY, array('id' => 'cost_id', ), 'CASCADE', null, 'Contracts');
    } // buildRelations()
