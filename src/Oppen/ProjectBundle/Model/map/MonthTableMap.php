...
class MonthTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Oppen.ProjectBundle.Model.map.MonthTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Oppen\\ProjectBundle\\Model\\Month');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Doc', 'Oppen\\ProjectBundle\\Model\\Doc', RelationMap::ONE_TO_MANY, array('id' => 'month_id', ), 'CASCADE', null, 'Docs');
        $this->addRelation('Contract', 'Oppen\\ProjectBundle\\Model\\Contract', RelationMap::ONE_TO_MANY, array('id' => 'month_id', ), 'CASCADE', null, 'Contracts');
    } // buildRelations()
