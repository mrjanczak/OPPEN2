...
use Oppen\ProjectBundle\Model\map\BookkEntryTableMap;
...
abstract class BaseBookkEntryPeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\BookkEntry';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\BookkEntryTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookkEntryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\BookkEntryTableMap());
      }
    }
