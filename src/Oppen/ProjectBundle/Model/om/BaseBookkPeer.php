...
use Oppen\ProjectBundle\Model\map\BookkTableMap;
...
abstract class BaseBookkPeer
{
    ...
    const TABLE_NAME = 'bookk';

    /** the related Propel class for this table */
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\Bookk';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\BookkTableMap';
    ...
    const DESC = 'bookk.desc';

    /** the column name for the is_accepted field */
    const IS_ACCEPTED = 'bookk.is_accepted';
    ...
    const PROJECT_ID = 'bookk.project_id';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Bookk objects.
    ...
    {
        $toNames = BookkPeer::getFieldNames($toType);
        $key = isset(BookkPeer::$fieldKeys[$fromType][$name]) ? BookkPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(BookkPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, BookkPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return BookkPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. BookkPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(BookkPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(BookkPeer::ID);
            $criteria->addSelectColumn(BookkPeer::NO);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(BookkPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = BookkPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return BookkPeer::populateObjects(BookkPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param Bookk $obj A Bookk object.
     ...
     *
     * @param      mixed $value A Bookk object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Bookk) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Bookk object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(BookkPeer::$instances[$key]);
        }
     ...
     * @return Bookk Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(BookkPeer::$instances[$key])) {
                return BookkPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (BookkPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        BookkPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to bookk
     * by a foreign key with ON DELETE CASCADE
     */
    public static function clearRelatedInstancePool()
    {
        // Invalidate objects in BookkEntryPeer instance pool,
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = BookkPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = BookkPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                BookkPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Bookk object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = BookkPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = BookkPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + BookkPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = BookkPeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of Bookk objects pre-filled with their Doc objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinDoc(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Bookk) to $obj2 (Doc)
                $obj2->addBookk($obj1);
    ...
    /**
     * Selects a collection of Bookk objects pre-filled with their Project objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Bookk objects.
    ...
    public static function doSelectJoinProject(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Bookk) to $obj2 (Project)
                $obj2->addBookk($obj1);
    ...
    /**
     * Selects a collection of Bookk objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(BookkPeer::DATABASE_NAME)->getTable(BookkPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseBookkPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseBookkPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\BookkTableMap());
      }
    }
    ...
    {
        return BookkPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Bookk or Criteria object.
     *
     * @param      mixed $values Criteria or Bookk object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from Bookk object
        }

        if ($criteria->containsKey(BookkPeer::ID) && $criteria->keyContainsValue(BookkPeer::ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Bookk or Criteria object.
     *
     * @param      mixed $values Criteria or Bookk object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(BookkPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(BookkPeer::ID);
            $value = $criteria->remove(BookkPeer::ID);
            if ($value) {
                $selectCriteria->add(BookkPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(BookkPeer::TABLE_NAME);
            }

        } else { // $values is Bookk object
    ...
    /**
     * Deletes all rows from the bookk table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BookkPeer::doOnDeleteCascade(new Criteria(BookkPeer::DATABASE_NAME), $con);
            $affectedRows += BasePeer::doDeleteAll(BookkPeer::TABLE_NAME, $con, BookkPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            BookkPeer::clearInstancePool();
            BookkPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a Bookk or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or Bookk object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof Bookk) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(BookkPeer::DATABASE_NAME);
            $criteria->add(BookkPeer::ID, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += BookkPeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                BookkPeer::removeInstanceFromPool($values);
            } else { // it's a primary key, or an array of pks
                foreach ((array) $values as $singleval) {
                    BookkPeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = BookkPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related BookkEntry objects
            $criteria = new Criteria(BookkEntryPeer::DATABASE_NAME);

            $criteria->add(BookkEntryPeer::BOOKK_ID, $obj->getId());
            $affectedRows += BookkEntryPeer::doDelete($criteria, $con);
        }
    ...
    /**
     * Validates all modified columns of given Bookk object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param Bookk $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(BookkPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(BookkPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(BookkPeer::DATABASE_NAME, BookkPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = BookkPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(BookkPeer::DATABASE_NAME);
        $criteria->add(BookkPeer::ID, $pk);

        $v = BookkPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(BookkPeer::DATABASE_NAME);
            $criteria->add(BookkPeer::ID, $pks, Criteria::IN);
            $objs = BookkPeer::doSelect($criteria, $con);
        }
