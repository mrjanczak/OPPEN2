...
use Oppen\ProjectBundle\Model\map\ContractTableMap;
...
abstract class BaseContractPeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\Contract';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\ContractTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseContractPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\ContractTableMap());
      }
    }
