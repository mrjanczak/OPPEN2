...
abstract class BaseCostIncome extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Oppen\\ProjectBundle\\Model\\CostIncomePeer';
     ...
     * @return CostIncome The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CostIncomePeer::ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = CostIncomePeer::VALUE;
        }
    ...
    public function setCostId($v)
    {
        ...
        if ($this->cost_id !== $v) {
            $this->cost_id = $v;
            $this->modifiedColumns[] = CostIncomePeer::COST_ID;
        }
    ...
    public function setIncomeId($v)
    {
        ...
        if ($this->income_id !== $v) {
            $this->income_id = $v;
            $this->modifiedColumns[] = CostIncomePeer::INCOME_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cost_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = CostIncomePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CostIncome object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CostIncomePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CostIncomeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CostIncomePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CostIncomePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CostIncomePeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }
        if ($this->isColumnModified(CostIncomePeer::COST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`cost_id`';
        }
        if ($this->isColumnModified(CostIncomePeer::INCOME_ID)) {
            $modifiedColumns[':p' . $index++]  = '`income_id`';
        }

        $sql = sprintf(
            'INSERT INTO `cost_income` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CostIncomePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CostIncomePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CostIncome'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CostIncome'][$this->getPrimaryKey()] = true;
        $keys = CostIncomePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getValue(),
            $keys[2] => $this->getCostId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCostId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CostIncomePeer::ID)) $criteria->add(CostIncomePeer::ID, $this->id);
        if ($this->isColumnModified(CostIncomePeer::VALUE)) $criteria->add(CostIncomePeer::VALUE, $this->value);
        if ($this->isColumnModified(CostIncomePeer::COST_ID)) $criteria->add(CostIncomePeer::COST_ID, $this->cost_id);
        if ($this->isColumnModified(CostIncomePeer::INCOME_ID)) $criteria->add(CostIncomePeer::INCOME_ID, $this->income_id);
    ...
    {
        $criteria = new Criteria(CostIncomePeer::DATABASE_NAME);
        $criteria->add(CostIncomePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CostIncome (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CostIncome Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CostIncomePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CostIncomePeer();
        }
    ...
    public function getCost(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCost === null && ($this->cost_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCost->addCostIncomes($this);
             */
        }
    ...
    public function getIncome(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aIncome === null && ($this->income_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aIncome->addCostIncomes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CostIncomePeer::DEFAULT_STRING_FORMAT);
    }
