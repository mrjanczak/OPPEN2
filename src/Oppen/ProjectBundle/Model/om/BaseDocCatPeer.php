...
use Oppen\ProjectBundle\Model\map\DocCatTableMap;
...
abstract class BaseDocCatPeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\DocCat';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\DocCatTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseDocCatPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\DocCatTableMap());
      }
    }
