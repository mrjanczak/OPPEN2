...
abstract class BaseDocCatQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Oppen\\ProjectBundle\\Model\\DocCat';
        }
    ...
    public function useCommitmentAccQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CommitmentAcc', '\Oppen\ProjectBundle\Model\AccountQuery');
    }
    ...
    public function useTaxCommitmentAccQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'TaxCommitmentAcc', '\Oppen\ProjectBundle\Model\AccountQuery');
    }
