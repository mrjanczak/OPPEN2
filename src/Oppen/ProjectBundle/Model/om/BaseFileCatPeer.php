...
use Oppen\ProjectBundle\Model\map\FileCatTableMap;
...
abstract class BaseFileCatPeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\FileCat';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\FileCatTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseFileCatPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\FileCatTableMap());
      }
    }
