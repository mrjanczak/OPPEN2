...
use Oppen\ProjectBundle\Model\map\FileTableMap;
...
abstract class BaseFilePeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\File';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\FileTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseFilePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\FileTableMap());
      }
    }
