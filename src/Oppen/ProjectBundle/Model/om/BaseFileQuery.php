...
abstract class BaseFileQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Oppen\\ProjectBundle\\Model\\File';
        }
    ...
    public function useSubFileQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SubFile', '\Oppen\ProjectBundle\Model\FileQuery');
    }
    ...
    public function useBookkEntryRelatedByFileLev1IdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'BookkEntryRelatedByFileLev1Id', '\Oppen\ProjectBundle\Model\BookkEntryQuery');
    }
    ...
    public function useBookkEntryRelatedByFileLev2IdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'BookkEntryRelatedByFileLev2Id', '\Oppen\ProjectBundle\Model\BookkEntryQuery');
    }
    ...
    public function useBookkEntryRelatedByFileLev3IdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'BookkEntryRelatedByFileLev3Id', '\Oppen\ProjectBundle\Model\BookkEntryQuery');
    }
