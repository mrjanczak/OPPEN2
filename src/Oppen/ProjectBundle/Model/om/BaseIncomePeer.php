...
use Oppen\ProjectBundle\Model\map\IncomeTableMap;
...
abstract class BaseIncomePeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\Income';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\IncomeTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseIncomePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\IncomeTableMap());
      }
    }
