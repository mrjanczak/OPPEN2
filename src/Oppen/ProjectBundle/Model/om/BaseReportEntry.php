...
abstract class BaseReportEntry extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Oppen\\ProjectBundle\\Model\\ReportEntryPeer';
    ...
    /**
     * The value for the formula field.
     * @var        string
     */
    protected $formula;
     ...
     * @return ReportEntry The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ReportEntryPeer::ID;
        }
    ...
    public function setNo($v)
    {
        ...
        if ($this->no !== $v) {
            $this->no = $v;
            $this->modifiedColumns[] = ReportEntryPeer::NO;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ReportEntryPeer::NAME;
        }
    ...
    public function setSymbol($v)
    {
        ...
        if ($this->symbol !== $v) {
            $this->symbol = $v;
            $this->modifiedColumns[] = ReportEntryPeer::SYMBOL;
        }
    ...
    /**
     * Set the value of [formula] column.
     *
     * @param  string $v new value
     * @return ReportEntry The current object (for fluent API support)
     */
    public function setFormula($v)
    {
        ...
        if ($this->formula !== $v) {
            $this->formula = $v;
            $this->modifiedColumns[] = ReportEntryPeer::FORMULA;
        }
    ...
    public function setReportId($v)
    {
        ...
        if ($this->report_id !== $v) {
            $this->report_id = $v;
            $this->modifiedColumns[] = ReportEntryPeer::REPORT_ID;
        }
    ...
    public function setTreeLeft($v)
    {
        ...
        if ($this->tree_left !== $v) {
            $this->tree_left = $v;
            $this->modifiedColumns[] = ReportEntryPeer::TREE_LEFT;
        }
    ...
    public function setTreeRight($v)
    {
        ...
        if ($this->tree_right !== $v) {
            $this->tree_right = $v;
            $this->modifiedColumns[] = ReportEntryPeer::TREE_RIGHT;
        }
    ...
    public function setTreeLevel($v)
    {
        ...
        if ($this->tree_level !== $v) {
            $this->tree_level = $v;
            $this->modifiedColumns[] = ReportEntryPeer::TREE_LEVEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->no = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->symbol = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->formula = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->report_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            ...
            return $startcol + 9; // 9 = ReportEntryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ReportEntry object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ReportEntryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ReportEntryQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // nested_set behavior
            if ($this->isRoot()) {
                throw new PropelException('Deletion of a root node is disabled for nested sets. Use ReportEntryPeer::deleteTree($scope) instead to delete an entire tree');
            }
            ...
            if ($ret) {
                ...
                if ($this->isInTree()) {
                    ...
                    ReportEntryPeer::shiftRLValues(-2, $this->getRightValue() + 1, null, $this->getScopeValue(), $con);
                }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isNew() && $this->isRoot()) {
                ...
                $nbRoots = ReportEntryQuery::create()
                    ->addUsingAlias(ReportEntryPeer::LEFT_COL, 1, Criteria::EQUAL)
                    ->addUsingAlias(ReportEntryPeer::SCOPE_COL, $this->getScopeValue(), Criteria::EQUAL)
                    ->count($con);
                if ($nbRoots > 0) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ReportEntryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ReportEntryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ReportEntryPeer::NO)) {
            $modifiedColumns[':p' . $index++]  = '`no`';
        }
        if ($this->isColumnModified(ReportEntryPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ReportEntryPeer::SYMBOL)) {
            $modifiedColumns[':p' . $index++]  = '`symbol`';
        }
        if ($this->isColumnModified(ReportEntryPeer::FORMULA)) {
            $modifiedColumns[':p' . $index++]  = '`formula`';
        }
        if ($this->isColumnModified(ReportEntryPeer::REPORT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`report_id`';
        }
        if ($this->isColumnModified(ReportEntryPeer::TREE_LEFT)) {
            $modifiedColumns[':p' . $index++]  = '`tree_left`';
        }
        if ($this->isColumnModified(ReportEntryPeer::TREE_RIGHT)) {
            $modifiedColumns[':p' . $index++]  = '`tree_right`';
        }
        if ($this->isColumnModified(ReportEntryPeer::TREE_LEVEL)) {
            $modifiedColumns[':p' . $index++]  = '`tree_level`';
        }

        $sql = sprintf(
            'INSERT INTO `report_entry` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`no`':
                        $stmt->bindValue($identifier, $this->no, PDO::PARAM_STR);
                        break;
                    case '`name`':
                    ...
                    case '`symbol`':
                        ...
                        break;
                    case '`formula`':
                        $stmt->bindValue($identifier, $this->formula, PDO::PARAM_STR);
                        break;
                    case '`report_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ReportEntryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ReportEntryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ReportEntry'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ReportEntry'][$this->getPrimaryKey()] = true;
        $keys = ReportEntryPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNo(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getSymbol(),
            $keys[4] => $this->getFormula(),
            $keys[5] => $this->getReportId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setFormula($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setReportId($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReportEntryPeer::ID)) $criteria->add(ReportEntryPeer::ID, $this->id);
        if ($this->isColumnModified(ReportEntryPeer::NO)) $criteria->add(ReportEntryPeer::NO, $this->no);
        if ($this->isColumnModified(ReportEntryPeer::NAME)) $criteria->add(ReportEntryPeer::NAME, $this->name);
        if ($this->isColumnModified(ReportEntryPeer::SYMBOL)) $criteria->add(ReportEntryPeer::SYMBOL, $this->symbol);
        if ($this->isColumnModified(ReportEntryPeer::FORMULA)) $criteria->add(ReportEntryPeer::FORMULA, $this->formula);
        if ($this->isColumnModified(ReportEntryPeer::REPORT_ID)) $criteria->add(ReportEntryPeer::REPORT_ID, $this->report_id);
        if ($this->isColumnModified(ReportEntryPeer::TREE_LEFT)) $criteria->add(ReportEntryPeer::TREE_LEFT, $this->tree_left);
        if ($this->isColumnModified(ReportEntryPeer::TREE_RIGHT)) $criteria->add(ReportEntryPeer::TREE_RIGHT, $this->tree_right);
        if ($this->isColumnModified(ReportEntryPeer::TREE_LEVEL)) $criteria->add(ReportEntryPeer::TREE_LEVEL, $this->tree_level);
    ...
    {
        $criteria = new Criteria(ReportEntryPeer::DATABASE_NAME);
        $criteria->add(ReportEntryPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ReportEntry (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setFormula($this->getFormula());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ReportEntry Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ReportEntryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ReportEntryPeer();
        }
    ...
    public function getReport(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aReport === null && ($this->report_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aReport->addReportEntries($this);
             */
        }
     ...
     *
     * @param      ReportEntry $node Propel node object
     * @return     bool
     */
     ...
     *
     * @param      ReportEntry $parent
     * @return     ReportEntry The current object, for fluid interface
     */
    ...
    public function getParent(PropelPDO $con = null)
    {
        if ($this->aNestedSetParent === null && $this->hasParent()) {
            $this->aNestedSetParent = ReportEntryQuery::create()
                ->ancestorsOf($this)
                ->orderByLevel(true)
                ->findOne($con);
        }
    ...
    {
        if (!ReportEntryPeer::isValid($this)) {
            return false;
        }

        return ReportEntryQuery::create()
    ...
    public function initNestedSetChildren()
    {
        ...
        $this->collNestedSetChildren->setModel('ReportEntry');
    }
     ...
     * @return     void
     */
    public function addNestedSetChild($reportEntry)
    {
        if ($this->collNestedSetChildren === null) {
            $this->initNestedSetChildren();
        }
        if (!in_array($reportEntry, $this->collNestedSetChildren->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->collNestedSetChildren[]= $reportEntry;
            $reportEntry->setParent($this);
        }
    }
     ...
     * @param      PropelPDO $con Connection to use.
     * @return     array     List of ReportEntry objects
     */
    public function getChildren($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collNestedSetChildren || null !== $criteria) {
            if ($this->isLeaf() || ($this->isNew() && null === $this->collNestedSetChildren)) {
                ...
                $collNestedSetChildren = ReportEntryQuery::create(null, $criteria)
                  ->childrenOf($this)
                  ->orderByBranch()
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function countChildren($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collNestedSetChildren || null !== $criteria) {
            if ($this->isLeaf() || ($this->isNew() && null === $this->collNestedSetChildren)) {
                ...
                return ReportEntryQuery::create(null, $criteria)
                    ->childrenOf($this)
                    ->count($con);
            }
        } else {
    ...
    public function getFirstChild($query = null, PropelPDO $con = null)
    {
        if ($this->isLeaf()) {
            ...
            return ReportEntryQuery::create(null, $query)
                ->childrenOf($this)
                ->orderByBranch()
                ->findOne($con);
        }
    ...
    public function getSiblings($includeNode = false, $query = null, PropelPDO $con = null)
    {
        if ($this->isRoot()) {
            return array();
             ...
             $query = ReportEntryQuery::create(null, $query)
     ...
     *
     * @param      ReportEntry $child	Propel object for child node
     *
     * @return     ReportEntry The current Propel object
     */
    public function addChild(ReportEntry $child)
    {
        if ($this->isNew()) {
            throw new PropelException('A ReportEntry object must not be new to accept children.');
        }
     ...
     *
     * @param      ReportEntry $parent	Propel object for parent node
     *
     * @return     ReportEntry The current Propel object
     */
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A ReportEntry object must not already be in the tree to be inserted. Use the moveToFirstChildOf() instead.');
        }
        ...
        $this->nestedSetQueries []= array(
            'callable'  => array('\\Oppen\ProjectBundle\Model\\ReportEntryPeer', 'makeRoomForLeaf'),
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A ReportEntry object must not already be in the tree to be inserted. Use the moveToLastChildOf() instead.');
        }
     ...
     * are not persisted until the current object is saved.
     *
     * @param      ReportEntry $sibling	Propel object for parent node
     *
     * @return     ReportEntry The current Propel object
     */
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A ReportEntry object must not already be in the tree to be inserted. Use the moveToPrevSiblingOf() instead.');
        }
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A ReportEntry object must not already be in the tree to be inserted. Use the moveToNextSiblingOf() instead.');
        }
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A ReportEntry object must be already in the tree to be moved. Use the insertAsFirstChildOf() instead.');
        }
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A ReportEntry object must be already in the tree to be moved. Use the insertAsLastChildOf() instead.');
        }
        if ($parent->isDescendantOf($this)) {
            throw new PropelException('Cannot move a node as child of one of its subtree nodes.');
        }
     ...
     * The modifications in the current object and the tree are immediate
     *
     * @param      ReportEntry $sibling	Propel object for sibling node
     * @param      PropelPDO $con	Connection to use.
     *
     * @return     ReportEntry The current Propel object
     */
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A ReportEntry object must be already in the tree to be moved. Use the insertAsPrevSiblingOf() instead.');
        }
        if ($sibling->isRoot()) {
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A ReportEntry object must be already in the tree to be moved. Use the insertAsNextSiblingOf() instead.');
        }
        if ($sibling->isRoot()) {
    ...
    protected function moveSubtreeTo($destLeft, $levelDelta, $targetScope = null, PropelPDO $con = null)
    {
        ...
        try {
            ...
            ReportEntryPeer::shiftRLValues($treeSize, $destLeft, null, $targetScope, $con);
            ...
            if ($targetScope != $scope) {
                ...
                ReportEntryPeer::shiftRLValues(-$right, $left, $right, $scope, $con);

                //update scopes
                ReportEntryPeer::setNegativeScope($targetScope, $con);

                //update levels
                ReportEntryPeer::shiftLevel($levelDelta, $left - $right, 0, $targetScope, $con);

                //move the subtree to the target
                ReportEntryPeer::shiftRLValues(($right - $left) + $destLeft, $left - $right, 0, $targetScope, $con);
            ...
            if (!$preventDefault) {
                ...
                if ($levelDelta) {
                    ...
                    ReportEntryPeer::shiftLevel($levelDelta, $left, $right, $scope, $con);
                }

                // move the subtree to the target
                ReportEntryPeer::shiftRLValues($destLeft - $left, $left, $right, $scope, $con);
            }

            // remove the empty room at the previous location of the subtree
            ReportEntryPeer::shiftRLValues(-$treeSize, $right + 1, null, $scope, $con);

            // update all loaded nodes
            ReportEntryPeer::updateLoadedNodes(null, $con);
     ...
     * so existing ReportEntry instances are probably invalid (except for the current one)
     *
     * @param      PropelPDO $con Connection to use.
     *
    ...
    public function deleteDescendants(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $ret = ReportEntryQuery::create()
                ->descendantsOf($this)
                ->delete($con);

            // fill up the room that was used by descendants
            ReportEntryPeer::shiftRLValues($left - $right + 1, $right, null, $scope, $con);
