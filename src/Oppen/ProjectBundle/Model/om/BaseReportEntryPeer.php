...
use Oppen\ProjectBundle\Model\map\ReportEntryTableMap;
...
abstract class BaseReportEntryPeer
{
    ...
    const OM_CLASS = 'Oppen\\ProjectBundle\\Model\\ReportEntry';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Oppen\\ProjectBundle\\Model\\map\\ReportEntryTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseReportEntryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Oppen\ProjectBundle\Model\map\ReportEntryTableMap());
      }
    }
