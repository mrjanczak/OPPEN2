...
abstract class BaseReportQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Oppen\\ProjectBundle\\Model\\Report';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Oppen\ProjectBundle\Model\ReportEntryQuery A secondary query class using the current class as primary query
     */
    public function useReportEntryQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinReportEntry($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ReportEntry', '\Oppen\ProjectBundle\Model\ReportEntryQuery');
    }
