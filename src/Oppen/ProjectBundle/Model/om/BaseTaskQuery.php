 ...
 * @method TaskQuery orderByDesc($order = Criteria::ASC) Order by the desc column
 * @method TaskQuery orderByFromDate($order = Criteria::ASC) Order by the from_date column
 * @method TaskQuery orderByToDate($order = Criteria::ASC) Order by the to_date column
 * @method TaskQuery orderByComment($order = Criteria::ASC) Order by the comment column
 * @method TaskQuery orderBySendReminder($order = Criteria::ASC) Order by the send_reminder column
 * @method TaskQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 * @method TaskQuery orderByProjectId($order = Criteria::ASC) Order by the project_id column
 ...
 * @method TaskQuery groupByDesc() Group by the desc column
 * @method TaskQuery groupByFromDate() Group by the from_date column
 * @method TaskQuery groupByToDate() Group by the to_date column
 * @method TaskQuery groupByComment() Group by the comment column
 * @method TaskQuery groupBySendReminder() Group by the send_reminder column
 * @method TaskQuery groupByUserId() Group by the user_id column
 * @method TaskQuery groupByProjectId() Group by the project_id column
 ...
 *
 * @method Task findOneByDesc(string $desc) Return the first Task filtered by the desc column
 * @method Task findOneByFromDate(string $from_date) Return the first Task filtered by the from_date column
 * @method Task findOneByToDate(string $to_date) Return the first Task filtered by the to_date column
 * @method Task findOneByComment(string $comment) Return the first Task filtered by the comment column
 * @method Task findOneBySendReminder(boolean $send_reminder) Return the first Task filtered by the send_reminder column
 * @method Task findOneByUserId(int $user_id) Return the first Task filtered by the user_id column
 * @method Task findOneByProjectId(int $project_id) Return the first Task filtered by the project_id column
 ...
 * @method array findByDesc(string $desc) Return Task objects filtered by the desc column
 * @method array findByFromDate(string $from_date) Return Task objects filtered by the from_date column
 * @method array findByToDate(string $to_date) Return Task objects filtered by the to_date column
 * @method array findByComment(string $comment) Return Task objects filtered by the comment column
 * @method array findBySendReminder(boolean $send_reminder) Return Task objects filtered by the send_reminder column
 * @method array findByUserId(int $user_id) Return Task objects filtered by the user_id column
 * @method array findByProjectId(int $project_id) Return Task objects filtered by the project_id column
...
abstract class BaseTaskQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Oppen\\ProjectBundle\\Model\\Task';
        }
    ...
    {
        $sql = 'SELECT `id`, `desc`, `from_date`, `to_date`, `comment`, `send_reminder`, `user_id`, `project_id`, `sortable_rank` FROM `task` WHERE `id` = :p0';
        try {
    ...
    public function filterByDesc($desc = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TaskPeer::DESC, $desc, $comparison);
    }
    ...
    public function filterByFromDate($fromDate = null, $comparison = null)
    {
        if (is_array($fromDate)) {
            ...
            if (isset($fromDate['min'])) {
                $this->addUsingAlias(TaskPeer::FROM_DATE, $fromDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($fromDate['max'])) {
                $this->addUsingAlias(TaskPeer::FROM_DATE, $fromDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TaskPeer::FROM_DATE, $fromDate, $comparison);
    }
    ...
    public function filterByToDate($toDate = null, $comparison = null)
    {
        if (is_array($toDate)) {
            $useMinMax = false;
            if (isset($toDate['min'])) {
                $this->addUsingAlias(TaskPeer::TO_DATE, $toDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($toDate['max'])) {
                $this->addUsingAlias(TaskPeer::TO_DATE, $toDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TaskPeer::TO_DATE, $toDate, $comparison);
    }
    ...
    public function filterByComment($comment = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TaskPeer::COMMENT, $comment, $comparison);
    }

    /**
     * Filter the query on the send_reminder column
     *
     * Example usage:
     * <code>
     * $query->filterBySendReminder(true); // WHERE send_reminder = true
     * $query->filterBySendReminder('yes'); // WHERE send_reminder = true
     * </code>
     *
     * @param     boolean|string $sendReminder The value to use as filter.
     ...
     * @return TaskQuery The current query, for fluid interface
     */
    public function filterBySendReminder($sendReminder = null, $comparison = null)
    {
        if (is_string($sendReminder)) {
            $sendReminder = in_array(strtolower($sendReminder), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(TaskPeer::SEND_REMINDER, $sendReminder, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(TaskPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(TaskPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TaskPeer::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByProjectId($projectId = null, $comparison = null)
    {
        if (is_array($projectId)) {
            ...
            if (isset($projectId['min'])) {
                $this->addUsingAlias(TaskPeer::PROJECT_ID, $projectId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($projectId['max'])) {
                $this->addUsingAlias(TaskPeer::PROJECT_ID, $projectId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TaskPeer::PROJECT_ID, $projectId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(TaskPeer::USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(TaskPeer::USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByProject($project, $comparison = null)
    {
        if ($project instanceof Project) {
            return $this
                ->addUsingAlias(TaskPeer::PROJECT_ID, $project->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(TaskPeer::PROJECT_ID, $project->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
